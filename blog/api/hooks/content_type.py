...
class ContentTypeHook(hooks.PecanHook):
    def __init__(self, content_type, methods=['GET']):
        ...
        print "------ api/hooks/content_type.ContentTypeHook.__init__() 35"

    def after(self, state):
        print "------api/hooks/content_type.ContentTypeHook.after() 39 state.request.method:" + state.request.method
