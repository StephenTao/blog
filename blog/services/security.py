...
from blog.utils.openstack import keystone
...
CONF.import_opt('auth_enable', 'blog.config', group='pecan')


DEFAULT_PROJECT_ID = "blog"
...
def create_context(trust_id, project_id):
    """Creates log security context.

    :param trust_id: Trust Id.
    :param project_id: Project Id.
    :return: Blog security context.
    """
    if not trust_id:
        return
