...
def wrap_messaging_exception(method):
    """This decorator unwrap remote error in one of BlogException.
    ...
    to API. Wrapped RemoteError contains one of BlogException raised
